...
export default function ResultPage() {
  ...
  const chartData = results.map((r) => ({
    name:
      r.diseaseName.length > 20
        ? r.diseaseName.substring(0, 20) + "..."
        : r.diseaseName,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Analisis berdasarkan gejala yang Anda alami
          </p>
        </div>
        ...
        !consultation.patientGender ? null : (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              {consultation.patientAge > 0 && (
                <div>
                  <p className="text-sm text-gray-600">Usia</p>
                  <p className="font-semibold text-gray-900">
                    {consultation.patientAge} tahun
                  </p>
                </div>
              )}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <h2 className="text-xl font-bold text-gray-800 mb-6">
            Grafik Probabilitas Semua Penyakit
          </h2>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <ul className="text-sm text-yellow-700 space-y-1 list-disc list-inside">
                <li>
                  Hasil diagnosis ini bersifat <strong>prediktif</strong> dan
                  bukan diagnosis final.
                </li>
                <li>
                  Sistem menggunakan <strong>Teorema Bayes</strong> dengan
                  metode Forward Chaining untuk analisis.
                </li>
                <li>
                  Segera konsultasi dengan{" "}
                  <strong>psikolog atau psikiater berlisensi</strong> untuk
                  diagnosis yang akurat.
                </li>
                <li>
                  Jangan menggunakan hasil ini untuk self-diagnosis atau
                  self-medication.
                </li>
              </ul>
            </div>
